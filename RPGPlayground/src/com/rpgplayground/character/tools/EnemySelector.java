...
public class EnemySelector {
	...
	private void createEnemies() {
		enemy = new EnemyCharacter("Goblin", 1, 18, 7, 4, 0, 3);
		enemy.setNewAbility(10101);
		allEnemies.add(enemy);
		enemy = new EnemyCharacter("Tough Goblin", 2, 21, 10, 5, 0, 4);
		enemy.setNewAbility(10101);
		allEnemies.add(enemy);
		enemy = new EnemyCharacter("Cowardly Goblin", 3, 14, 5, 3, 0, 2);
		enemy.setNewAbility(10101);
		allEnemies.add(enemy);
		enemy = new EnemyCharacter("Goblin Warrior", 4, 25, 14, 7, 0, 7);
		enemy.setNewAbility(10101);
		allEnemies.add(enemy);
		enemy = new EnemyCharacter("Gargoyle", 5, 44, 5, 12, 0, 9);
		enemy.setNewAbility(10101);
		allEnemies.add(enemy);
		enemy = new EnemyCharacter("Stone Golem", 6, 60, 9, 18, 2, 12);
		enemy.setNewAbility(10101);
		allEnemies.add(enemy);
	}
